<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PatientHistory.aspx.cs" Inherits="Form_General_PatientHistory" %>
...
<asp:Content ID="PatientHistoryData" ContentPlaceHolderID="MainContent" runat="server">
    <style type="text/css">
        .shadows {
            border: 1px;
            border-radius: 15px;
    ...
    <script type="text/javascript">
        ...
        function Preview(admissionId, encounterId) {
            document.getElementById('<%=hfAdmissionId.ClientID%>').value = admissionId;
            document.getElementById('<%=hfEncounterId.ClientID%>').value = encounterId;
        ...
        function tab_patientHistory(content) {
            ...
            if (content == 1) { // validasi untuk tab Electronic Unit MR
                ...
                var btn_load_more = document.getElementById('<%= btn_load_more.ClientID%>');
                ...
                var hopemr_iframe = document.getElementById('<%= myIframe.ClientID %>');
        ...
        function switchBahasa() {
            ...
            if (bahasa == "ENG") {
                document.getElementById('lblbhs_unitemrdate').innerHTML = "Date";
                document.getElementById('lblbhs_otheremryears').innerHTML = "Years";
                document.getElementById('lblbhs_otheremrdate').innerHTML = "Date";
                document.getElementById('lblbhs_scanemrdate').innerHTML = "Date";
                document.getElementById('lblbhs_hopeemrdate').innerHTML = "Date";
                //document.getElementById('lblbhs_nodataunitemr').innerHTML = "Oops! There is no data";
                //document.getElementById('lblbhs_subnodataunitemr').innerHTML = "Please search another date or parameter";
                document.getElementById('lblbhs_nodatascanemr').innerHTML = "Oops! There is no data";
                document.getElementById('lblbhs_subnodatascanemr').innerHTML = "Please search another date or parameter";
                document.getElementById('lblbhs_nodatahopeemr').innerHTML = "Oops! There is no data";
                document.getElementById('lblbhs_subnodatahopeemr').innerHTML = "Please search another date or parameter";
                document.getElementById('lblbhs_nodataotheremr').innerHTML = "Oops! There is no data";
                document.getElementById('lblbhs_subnodataotheremr').innerHTML = "Please search another date or parameter";
                //document.getElementById('lblbhs_loadmore').innerHTML = "Load More...";
            }
            else if (bahasa == "IND") {
                document.getElementById('lblbhs_unitemrdate').innerHTML = "Tanggal";
                document.getElementById('lblbhs_otheremryears').innerHTML = "Tahun";
                document.getElementById('lblbhs_otheremrdate').innerHTML = "Tanggal";
                document.getElementById('lblbhs_scanemrdate').innerHTML = "Tanggal";
                document.getElementById('lblbhs_hopeemrdate').innerHTML = "Tanggal";
                //document.getElementById('lblbhs_nodataunitemr').innerHTML = "Oops! Tidak ada data";
                //document.getElementById('lblbhs_subnodataunitemr').innerHTML = "Silakan cari tanggal atau parameter lain";
                document.getElementById('lblbhs_nodatascanemr').innerHTML = "Oops! Tidak ada data";
                document.getElementById('lblbhs_subnodatascanemr').innerHTML = "Silakan cari tanggal atau parameter lain";
                document.getElementById('lblbhs_nodatahopeemr').innerHTML = "Oops! Tidak ada data";
                document.getElementById('lblbhs_subnodatahopeemr').innerHTML = "Silakan cari tanggal atau parameter lain";
                document.getElementById('lblbhs_nodataotheremr').innerHTML = "Oops! Tidak ada data";
                document.getElementById('lblbhs_subnodataotheremr').innerHTML = "Silakan cari tanggal atau parameter lain";
                //document.getElementById('lblbhs_loadmore').innerHTML = "Muat Lebih Banyak...";
            }
        }
    ...
    <asp:UpdatePanel runat="server" ID="UPpatientHistoryResult">
        <ContentTemplate>
            <div class="container-fluid kartu-pasien">
                <tag1:PatientCard runat="server" ID="PatientCard" style="width: 100%" />
            ...
            <div style="width: 100%; height: 45px; background-color: #e7e8ed; z-index: 4; position: sticky; top: 125px;">
            ...
            <div style="background: #fdfdfd; min-height: calc(100vh - 170px); padding-bottom: 5px;">
                        ...
                        <div id="src_emr" runat="server" style="display: none">
                            <table border="0" style="float: right;">
                                <tr>
                                    ...
                                    <td style="width: 20px; text-align: center;">&nbsp; </td>
                                    <td>
                                        <asp:Button ID="btn_search_emr" runat="server" Text="Search" CssClass="btn btn-lightGreen btn-emr-small" OnClick="btn_search_Click" /></td>
                                </tr>
                            </table>
                        </div>
                ...
                <div style="width: 100%;">
                    ...
                    <div id="emr_div" runat="server" style="display: block">
                        ...
                        <iframe name="emr_data" id="emr_data" runat="server" style="width: 100%; height: calc(100vh - 172px); border: none; overflow-y: auto; margin-bottom: -9px;"></iframe>
                    ...
                    <div id="hope_emr_div" runat="server" style="display: none;">
                        ...
                        <%--<div class="container-fluid" style="margin-top: 13px; margin-bottom: 8px;">
                        ...
                        <div class="row" style="margin: 20px;">
                            <div class="col-sm-2 no-padding" style="border-radius: 7px; border: solid 2px lightgrey;">
                                <div id="hope__emr" runat="server" class="scrollEMR" style="width: 100%; overflow-y: auto; height: calc(100vh - 258px)">
                                    <asp:GridView runat="server" ID="gvHopeMRList" AutoGenerateColumns="False" Width="100%"
                                        CssClass="table-condensed table-hover" ShowHeader="false" BorderWidth="0" BorderColor="LightGray">
                                        <Columns>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="btnTanggalHopeMR" runat="server" OnClick="btnTanggalHopeMR_Click">
                                                        <div style="padding: 5px; margin-top: -6px; border-top: 1px solid lightgrey;">
                                                            ...
                                                            <asp:Label runat="server" ID="lblHopeMrAdmNo" Style="color: #444444;" Text='<%# Bind("admTypePlusAdmId") %>'></asp:Label>
                                                            <br />
                                                            <asp:Label runat="server" ID="lblHopeMrDoc" Style="color: #444444;" Text='<%# Bind("entryUser") %>'></asp:Label>
                            ...
                            <div class="col-sm-10" style="padding-right: 0px;">
                                <div style="border-radius: 7px; border: solid 2px lightgrey;">
                                    <iframe name="myIframe" id="myIframe" runat="server" style="width: 100%; min-height: calc(100vh - 258px); border: none; display: block;"></iframe>

                                    <div id="img_noData_hope_emr" runat="server" style="text-align: center; min-height: calc(100vh - 258px); display: none;">
                                        <div>
                                            <br />
                                            <br />
                                            <img src="<%= Page.ResolveClientUrl("~/Images/Background/ic_noData.svg") %>" style="height: auto; width: 200px; margin-right: 3px; margin-top: 40px" />
                    ...
                    <div id="other_unit_emr" runat="server" style="display: none;">
                        ...
                        <div class="container-fluid" style="margin-top: 13px; margin-bottom: 8px; display: none;">
                            <div class="col-sm-2" style="font-size: 14px; font-family: Arial, Helvetica, sans-serif; padding-left: 0px"><b>Other Unit EMR</b></div>
                        </div>
                    ...
                    <div class="text-center" runat="server" style="display: none">
                        <asp:LinkButton runat="server" ID="btn_load_more" CssClass="btn btn-default" OnClick="btn_load_more_Click">
                            <%--<label style="display: <%=setENG%>;"> Load More... </label>
                            <label style="display: <%=setIND%>;"> Muat Lebih Banyak... </label>--%>
                            <label id="lblbhs_loadmore" style="cursor:pointer;"> Load More... </label>
                        </asp:LinkButton>
                    </div>
        ...
        <div style="width: 80%; height: 85%; vertical-align: middle" class="container-fluid">
            <div class="modal-content">
                <div class="modal-header" style="height: 40px; padding-top: 10px; padding-bottom: 5px">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" style="text-align: left">
                        <asp:Label ID="Label1" Style="font-family: Helvetica, Arial, sans-serif; font-weight: bold" runat="server" Text="Medical Resume"></asp:Label></h4>
                    <div style="text-align: center; background-color: lightgray;">
                        ...
                        <asp:LinkButton runat="server" ID="preview" CssClass="btn btn-primary" Target="_blank">Save as PDF</asp:LinkButton>
                    </div>
                    <br />
                </div>
                <br />
    ...
    <div class="modal fade" id="modalCompound" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <asp:UpdatePanel ID="UPCompound" runat="server">
            <ContentTemplate>
