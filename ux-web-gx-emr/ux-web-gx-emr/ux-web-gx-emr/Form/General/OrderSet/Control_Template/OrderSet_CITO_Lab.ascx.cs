...
public partial class Form_General_OrderSet_Control_Template_OrderSet_CITO_Lab : System.Web.UI.UserControl
{
    ...
    public List<CpoeTrans> getDataChecklistCITO()
    {
    ...
    public void GetMappingCitoLab(List<CpoeMapping> listmap, IEnumerable<CpoeTrans> listCheck)
    {
        DataTable dt;
