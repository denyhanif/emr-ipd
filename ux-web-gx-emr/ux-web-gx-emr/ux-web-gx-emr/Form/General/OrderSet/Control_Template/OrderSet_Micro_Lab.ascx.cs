...
public partial class Form_General_OrderSet_Control_Template_OrderSet_Micro_Lab : System.Web.UI.UserControl
{
    ...
    public List<CpoeTrans> getDataChecklistMicro()
    {
    ...
    public void GetMappingMicroLab(List<CpoeMapping> listmap, IEnumerable<CpoeTrans> listCheck)
    {
        DataTable dt;
