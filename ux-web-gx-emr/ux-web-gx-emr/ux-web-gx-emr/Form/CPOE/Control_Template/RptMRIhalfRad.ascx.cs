...
public partial class Form_CPOE_Control_Template_RptMRIhalfRad : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //    setENG = "";
        //    setIND = "none";
        //    HFisBahasa_mrihalfrad.Value = "ENG";
        //}
        //else if (Session[Helper.SessionLanguage] == "2")
        //{
        //    setENG = "none";
        //    setIND = "";
        //    HFisBahasa_mrihalfrad.Value = "IND";
        //}
        //else
        //{
        //    setENG = "";
        ...
        //set bahasa
        //ScriptManager.RegisterStartupScript(this, GetType(), "bahasa", "switchBahasa_mrihalfrad();", true);
    ...
    public List<CpoeNotes> getvaluesnotes(List<CpoeNotes> cpoenotes)
    {
        ...
        else
        {
            ...
            tempnotes.notes_type = "MRI1";
            tempnotes.notes = txtMRIhalfNotes.Text;
                ...
                if (listmapping.Count > 0)
                {
                    if (flagFO == "true")
                    {
                        data = (
                                ...
                                where a.type == "MRI1" && a.organizationId != 0
                                select new LabList
                                {
