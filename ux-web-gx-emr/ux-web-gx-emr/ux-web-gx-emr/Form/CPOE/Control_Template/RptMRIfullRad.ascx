<%@ Control Language="C#" AutoEventWireup="true" CodeFile="RptMRIfullRad.ascx.cs" Inherits="Form_CPOE_Control_Template_RptMRIfullRad" %>
...
<div>
    <asp:HiddenField ID="HFisBahasa_mrifullrad" runat="server" />
    <asp:HiddenField ID="hfguidadditional" runat="server" />
    <%--<asp:UpdateProgress ID="uProgMRIFull" runat="server" AssociatedUpdatePanelID="upMRIFullRad">
        <ProgressTemplate>
    ...
    <%--<asp:UpdatePanel runat="server" ID="upMRIFullRad">
        <ContentTemplate>--%>
            ...
            <label id="lblbhs_workingdiag5"> Working Diagnosis </label>
                    </asp:Label>
                </div>
            </div>
            <div class="row" style="margin: 0px; padding-bottom: 0px; background-color: white; padding-top: 5px; display: none;">
                <div class="col-sm-12">
                    <asp:TextBox ID="txtMRIfullNotes" Style="height: 35px; border-radius: 6px; width: 100%; max-width: 100%" Font-Size="15px" runat="server" onkeypress="return checkenter();" CssClass="form-control"></asp:TextBox>
                </div>
            </div>
            <div class="row" style="margin: 0px; padding-bottom: 0px; background-color: white; padding-top: 10px; font-size: 11px;">
                <div class="col-sm-6">
                    <label>&nbsp; </label>
                    <br />
                    <label id="lblbhs_pleasetick1_mrifullrad">Please tick (&#10003) Rad test as request </label>
                </div>
                <div class="col-sm-6 text-right">
                    <label id="lblbhs_pleasetick2_mrifullrad">&#42Fasting minimal 4 hours before examinations</label>
                </div>
            </div>
            ...
            <div class="row" style="margin: 0px; padding-bottom: 20px; background-color: white; padding-top: 0px">
                <div class="col-sm-6" style="padding-top: 0px; background-color: white">
                    ...
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw1">
                                ...
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                ...
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw1');" />
                                    </td>
                                    <td style="width:15%;">
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw1');" />
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw3">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw3');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw3');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw5">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw5');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw5');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw7">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw7');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw7');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw11">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw11');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw11');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw9">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw9');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw9');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                ...
                <div class="col-sm-6" style="padding-top: 0px; background-color: white">
                    ...
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw2">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw2');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw2');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw4">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw4');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw4');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw6">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw6');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw6');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw8">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw8');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw8');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
                    ...
                    <div style="padding-bottom: 20px; background-color: white"></div>
                    <table style="width:100%;" id="MainContent_StdPlanning_TabContainer2_MRI3_stdmrifull_gvw10">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td style="width:70%;">
                                        <asp:CheckBox runat="server" Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Text='<%# Eval("item_name").ToString() + " " + (Eval("fasting_flag").ToString()=="0" ? "" : Eval("fasting_flag").ToString()=="1" ? "*" : "**") %>'
                                                Value="10" ID="chk1" Checked='<%# Eval("is_checked").ToString() != "0" %>' CssClass="std"
                                                onclick="return serviceselectedmrifull(this,'MRI3','Right','gvw10');" />
                                    </td>
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbRight" GroupName='<%# Eval("item_name").ToString() %>' Text="R"
                                                Enabled='<%# Eval("issubmit").ToString() != "1" && Eval("IsSendHope").ToString() != "1" %>' Value="R" CssClass="std"
                                    ...
                                    <td style="width:15%;">
                                        <asp:RadioButton runat="server" ID="rbLeft" GroupName='<%# Eval("item_name").ToString() %>' Text="L"
                                                ...
                                                Visible='<%# Eval("is_leftright").ToString() != "False" %>'
                                                Checked='<%# Eval("remarks").ToString() == "Left" %>'
                                                onclick="return serviceselectedmrifull(this,'MRI3','Left','gvw10');" />
                                    </td>
                                    <td style="display:none;">
                                        <%# Eval("item_id").ToString() %> 
                                    </td>
