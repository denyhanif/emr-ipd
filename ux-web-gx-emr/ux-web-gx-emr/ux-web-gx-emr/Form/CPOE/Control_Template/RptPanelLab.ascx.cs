...
public partial class Form_CPOE_Control_Template_RptPanelLab : System.Web.UI.UserControl
{
    ...
    public void SetIPlocal(string ip)
    {
        iplocal.Value = ip;
    }
    public void GetMappingPanelLab(List<CpoeMapping> listmap, string guidadditional, string flagFO)
    {
