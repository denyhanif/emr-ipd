<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="StdSoapPageLite.aspx.cs" Inherits="Form_SOAP_Template_StdSoapPageLite" %>
...
<%@ Register Src="~/Form/SOAP/Control_Template/StdPlanning.ascx" TagPrefix="uc1" TagName="StdPlanning" %>
<%@ Register Src="~/Form/SOAP/Control_Template/StdImunisasi.ascx" TagPrefix="uc1" TagName="StdImunisasi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
	<style>
		...
		.disabled-form-skriningPenyakit {
			display: none
		}
		...
		#modal-rawatinap:required:focus {
	...
	<body onkeyup="closeTheLoading();">
		...
		<div id="divpage" runat="server">
			...
			<div class="container-fluid bawah-kartu-pasien">
				<div class="row" style="padding-left: 15px; padding-top: 8px">
					...
					<asp:Button runat="server" CssClass="btn btn-lightGreen" Text="Choose" Style="width: 71px; height: 25px; padding-top: 3px; border-radius: 4px; background-color: #4d9b35; font-family: Helvetica; font-size: 12px; color: #ffffff" OnClick="btnChoose_onClick" />
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-sm-8" style="display: inline-flex;">
													<asp:TextBox ID="TxtReminderNotes" placeholder="Type reminder here..." runat="server" Style="width: 80%; margin-right: 5px;" onkeydown="return txtOnKeyPressReminder();"></asp:TextBox>
													<table>
														<tr>
															<td>
							...
							<div class="mini-dialog" runat="server" id="divTopSOAP">
								...
								<div class="row mini-header" style="border-bottom: solid 1px #efefef; margin-left: 0px; margin-right: 0px;">
									<div class="col-sm-6" style="padding-left: 0px;">
										<a title="Compare" href="javascript:$('#modalCompareSOAP').modal();">SOAP </a>
									</div>
									<div class="col-sm-6 text-right" style="padding-right: 0px;">
										<a href="javascript:resetSOAP();" style="margin-right: 10px; cursor: pointer; color: #c43d32; text-decoration: underline;">Reset SOAP </a>
									</div>
								</div>
											...
											<div class="row" style="margin-left: 15px">
												<asp:UpdatePanel ID="UP_printrawatinap" runat="server">
													<ContentTemplate>
														...
														<asp:LinkButton ID="BtnEditRawatInap" Text="Edit Rawat Inap" Style="font-family: Helvetica; font-weight: bold; font-size: 12px; color: #3A3680; text-decoration: underline; padding-right: 20px; border-right: 0.5px solid #B9B9B9;" runat="server" href="javascript:$('#modal-rawatinap').modal();$('#BtnHideInpatient').trigger('click');" CommandName="DeleteRow" CommandArgument='' />
		...
		<div class="itemcontainersave" style="position: fixed; right: -165px; top: 84%; transform: translate(0,-50%); text-align: left; z-index: 20">
			<div id="btnsubmitsigndiv" runat="server">
				...
				<a href="javascript:ModalSubmit();" class="itemsign"><span>
			...
			<div class="modal-dialog" style="top: 2%; width: 86%;">
				<div class="modal-content" style="border-radius: 6px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.24);">
					...
					<div class="modal-body" id="divFAmodal" runat="server">
						...
						<div class="header-pasien-FA" style="margin-bottom: 0px">
						...
						<asp:UpdatePanel ID="UP_Kewaspadaan" runat="server" UpdateMode="Conditional">
							<ContentTemplate>
								<div id="divKewaspadaan" runat="server" class="row" style="padding: 0; background-color: #FEEEC1; display:none">
									<div class="divKewaspadaan" runat="server" style="width: 100%; margin-bottom: 0; padding-left: 12px; padding-right: 7px;">
										<div>
											<div style="padding: 15px 10px 14px">
												<asp:Label ID="lblkewaspadaan" runat="server" CssClass="" Text="" Font-Size="20px" ForeColor="#8F701C">Kewaspadaan: <span id="listKewaspadaan" runat="server" style="font: normal normal bold 20px/24px Helvetica;"></span>
												</asp:Label>
											</div>
										</div>
									</div>
								...
								<div style="margin: 0px 14px">
									<div class="row">
										...
										<div id="dvEndemic" style="display: none; padding-top: 5px">
											<asp:TextBox runat="server" Style="border-radius: 2px; border: solid 1px #cdced9; max-width: 60%; width: 100%; resize: none; padding-left: 5px;" placeholder="Type here..." Font-Names="Helvetica, Arial, sans-serif" Font-Size="12px" ID="txtEndemic" TextMode="MultiLine" Rows="2" />
										</div>
										<%--</ContentTemplate>
                                        </asp:UpdatePanel>--%>
					...
					<div class="modal-dialog" style="top: 2%; width: 30%;">
						<div class="modal-content" style="border-radius: 6px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.24); padding-bottom: 0;">
							...
							<div class="modal-footer">
								<asp:Button ID="btnSvAlertDltReason" class="btn btn-lightGreen disabled-form" runat="server" Text="Save" OnClick="btnSvAlertDltReason_onClick" />
				...
				<div class="modal-content" style="border-radius: 6px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.24);">
					...
					<div class="modal-header" style="height: 35px; padding-top: 7px; padding-bottom: 5px">
						<h4 class="modal-title" style="text-align: center">
							<asp:Label runat="server" Font-Bold="true" ID="Label16" ClientIDMode="Static" Text="Hapus Semua Rujukan"></asp:Label></h4>
					</div>
		...
		<div class="modal fade" id="modal-delete-rawatinap">
			<div class="modal-dialog modal-sm" style="top: 100px; width: 320px; height: 172px">
				<div class="modal-content" style="border-radius: 6px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.24);">
					...
					<div class="modal-header" style="height: 35px; padding-top: 7px; padding-bottom: 5px">
						<h4 class="modal-title" style="text-align: center">
							<asp:Label runat="server" Font-Bold="true" ID="Label18" ClientIDMode="Static" Text="Hapus Rawat Inap"></asp:Label></h4>
					</div>
					...
					<div class="modal-footer justify-content-right">
						<asp:UpdatePanel ID="UpdatePanel7" runat="server">
							<ContentTemplate>
								...
								<button class="btncancelrujukan" data-dismiss="modal" aria-hidden="true">Close</button>
								<asp:Button ID="BtnDeleteRawatInap" CssClass="btndelrujukan" Style="margin-left: 30px;margin-right:10px"  runat="server" OnClick="BtnDeleteRawatInap_Click" Text="Delete All"></asp:Button>
							</ContentTemplate>
						</asp:UpdatePanel>
					</div>
				</div>
		...
		<div class="modal fade" id="modalsubmit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
			...
			<div class="modal-dialog" style="width: 40%; padding-top: 80px;">
				<div class="modal-content" style="border-radius: 6px; box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.24);">
					<div class="modal-header" style="height: 30px; padding-top: 5px; padding-bottom: 5px">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h5 class="modal-title">
							...
							<ContentTemplate>
								...
								<div class="row" style="padding-left: 5%; padding-right: 5%">
									...
									<div class="col-sm-6" style="text-align: right; font-size: 12px;">
										...
										<a href="javascript:submitvalidation();" class="btn btnsubmitclass" style="width: 112px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white">Submit & Sign</a>
										<asp:Button aria-hidden="true" ID="btnFinalSubmit" runat="server" CssClass="btn hidden" Style="width: 112px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white" Text="Submit & Sign" OnClick="btnSubmit_click" />
									</div>
									<div class="col-sm-12" style="text-align: right; font-size: 12px; padding-top: 15px;" id="divReferalButton" runat="server" visible="false">
										...
										<a href="javascript:submitvalidationTC();" class="btn btnsubmitclass" style="width: 145px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white">Submit, Sign & Refer</a>
										<asp:Button aria-hidden="true" ID="btnFinalSubmitTC" runat="server" CssClass="btn hidden" Style="width: 145px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white" Text="Submit, Sign & Refer" OnClick="btnSubmit_click" />
										<%--sama aja dg btn submit diatas--%>
									</div>
								</div>
							</ContentTemplate>
						</asp:UpdatePanel>
					...
					<div class="modal-body">
						<asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
							<ContentTemplate>
								...
								<!-- Procedure Encounter remark, move to outside of modal -->
								<div>&nbsp</div> 
								<%--<div class="row" style="padding-left: 5%">
									<div class="col-sm-6">
										<label style="font-size: 10px; font-family: Helvetica">
								...
								<div class="row" style="padding-left: 5%; padding-right: 5%">
									<div class="col-sm-12 hidden">
										<asp:TextBox runat="server" Style="outline-color: gray; max-width: 100%; width: 100%; border-radius: 4px; resize: none; font-family: Helvetica, Arial, sans-serif" placeholder="Type here..." BorderColor="gray" 
											ID="txtnotes" TextMode="MultiLine" Rows="3" onkeydown="checkTextAreaMaxLength(this,event,'100');" />
									</div>
									<%--<div class="col-sm-12">
										<!-- ## kotak pencarian autocomplete ## -->
										<asp:UpdatePanel runat="server">
								...
								<div class="row" style="padding-left: 5%; padding-right: 5%">
									...
									<div class="col-sm-6" style="text-align: right; font-size: 12px;">
										...
										<a href="javascript:submitvalidation();" class="btn btnsubmitclass" style="width: 112px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white">Submit & Sign</a>
										<asp:Button runat="server" aria-hidden="true" ID="btnFinalSubmitDisable" CssClass="btn hidden" Style="width: 112px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white" Text="Submit & Sign" OnClick="btnSubmitDisable_click" />
									</div>
									<div class="col-sm-12" style="text-align: right; font-size: 12px; padding-top: 15px;" id="divReferalButtonDisable" runat="server" visible="false">
										...
										<a href="javascript:submitvalidationTC();" class="btn btnsubmitclass" style="width: 145px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white">Submit, Sign & Refer</a>
										<asp:Button aria-hidden="true" ID="btnFinalSubmitDisableTC" runat="server" CssClass="btn hidden" Style="width: 145px; height: 32px; padding-top: 7px; font-size: 12px; border-radius: 4px; background-color: #4081ed; color: white" Text="Submit, Sign & Refer" OnClick="btnSubmitDisable_click" />
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		function checkfield() {
			var remarks = $("[id$='TBreferral_remark']").val();
			console.log(remarks);
			if (remarks.length <= 0) {
				console.log("ss");
				$("[id$='TBreferral_remark']").attr("style", "outline-color:red;max-width:100%; width:100%; margin-right: 5px;");

				$("[id$='TBreferral_remark']").focus();
				$("[id$='pError']").attr("style", "display:block; color:red;");
				document.getElementById("pError").innerHTML = "Masukkan Remarks !";
				return false;
			}
			return true;
		...
		function validateclosetag() {
			...
			var valueclinicaldiag = document.getElementById("MainContent_StdPlanning_txtclinicaldiagnosis").value;
			var resclinicaldiag = valueclinicaldiag;
			resclinicaldiag = resclinicaldiag.replace(/[^\x00-\x7F]/g, "?");
			resclinicaldiag = resclinicaldiag.replace(/</g, " < ").replace(/>/g, " > ");
			$("[id$='txtclinicaldiagnosis']").val(resclinicaldiag);
		}
		...
		function ModalSubmit() {
			...
			if (configsoap == 'TRUE') {
				//if (valueComplaint != '' && valueAnamnesis != '' && valuetxtPrimary != '' && valuetxtOthers != '' && valuetxtPlanning != '') {
				if (isEmpty(valueComplaint) == false && isEmpty(valueAnamnesis) == false && isEmpty(valuetxtPrimary) == false && isEmpty(valuetxtOthers) == false && isEmpty(valuetxtPlanning) == false) {
					...
					if (div_labradFO != null & div_labradFO.style.display == "block") {
						...
						console.log(txtOthersLab_fo.value);
						console.log(txtOthersRad_fo.value);
		...
		function checkInpatientData() {
            if ($('#MainContent_ModalRawatInap_textbox_diagnosis').val() == "") {
				...
				var intruksi_rawatinap = $("[id$='MainContent_ModalRawatInap_txtinstruksirawatinap']").val();

				var ddl_namaoperasi = $("[id$='MainContent_ModalRawatInap_ddl_namaoperasi'] option:selected").text();
                var ddl_anesteticmetod = $("[id$='MainContent_ModalRawatInap_ddl_anasteticmethod'] option:selected").text();

                var chbx_alattidak = $("[id$='MainContent_ModalRawatInap_chbx_alat_tidak']").is(':checked');
				...
				if (menit_operasi.length <= 0) {
					console.log("jam operasi kosong");
					notificationInptient("Menit Lama Operasi Tidak Boleh Kosong");
					$("[id$='MainContent_ModalRawatInap_txt_MenitLamaOperasi']").focus();
					$("[id$='MainContent_ModalRawatInap_txt_MenitLamaOperasi']").attr("style", "height:32px;width:69px;text-align:center;border-radius:4px;border:1px solid red");
		...
		function MimsWarningLog(flagg) {
			...
			//var chkreason1 = document.getElementById("MainContent_StdPlanning_Chk_Reason1");
			//var chkreason2 = document.getElementById("MainContent_StdPlanning_Chk_Reason2");
			//var chkreasonother = document.getElementById("MainContent_StdPlanning_Chk_ReasonOther");
			...
			$.ajax({
				type: "POST",
				url: "StdSoapPageLite.aspx/LogMims",
		...
		function klikSubmitSOAP(flagfn, vl) {
			...
			if (vlMA == true && vlHR == true) {
				...
				if (fl == "DRAFT") {
					...
					var savemode = $("[id$='hfsavemode']").val();
					if (savemode == '1') {
						document.getElementById("<%=btnFinalSubmitDisable.ClientID %>").click();
					}
					else {
